...
public class TestEP{
    /**
     * The main method runs test according to user input. 
    ...
    public static void main(String[] args){
        ...
        if (args.length==Correctinput){
            ...
            System.out.println ("Please enter pile length, test depth"+
    ...
    /**
     * Create a String representation of sorting steps, written to a file.
     * @param testDepth the depth of exam picked up by marker each time.
     */
